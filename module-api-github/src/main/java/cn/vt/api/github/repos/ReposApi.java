...
//        -d '{"encrypted_value":"c2VjcmV0","key_id":"012345678912345678"}'
        ...
        Pair<Integer, String> put = put("/repos/{owner}/{repo}/actions/secrets/{secretName}", requestBody, String.class, vars);
    ...
    public boolean createFileOrUpdateFileContent(CreateOrUpdateFileContentReq req) {
        ...
        // path不以/开头
        Pair<Integer, String> put = put("/repos/{username}/{reponame}/contents/{path}", requestBody, String.class, vars);
        int value = put.getLeft().intValue();
