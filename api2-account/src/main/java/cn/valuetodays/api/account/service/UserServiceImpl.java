...
// */
//@Named
//public class UserServiceImpl extends JpaServiceImpl<Long, UserPO, UserDAO> {
//    @Inject
...
//        natsConnection.publish(TOPIC_APPLICATION_MSG, msg.getBytes(StandardCharsets.UTF_8));
//        userLoginLogDAO.save(userLoginLogPO);
//    }
//
