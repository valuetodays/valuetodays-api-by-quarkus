 ...
 */
@Data
public class DjPbData implements Serializable, DjBaseData {
    @JsonProperty("horizontal_lines")
    private List<HorizontalLine> horizontalLines;
    @JsonProperty("index_eva_pb_growths")
    private List<IndexEvaPbGrowth> pbList;
    ...
    @Data
    public static class IndexEvaPbGrowth implements Serializable {
        private double pb;
        private long ts;
    }
}
